...
data(foxes)
fox_data <- foxes
fox_data$st_weight <- standardize(fox_data$weight)
fox_data$st_area <- standardize(fox_data$area)
fox_data$st_avgfood <- standardize(fox_data$avgfood)
fox_data$st_groupsize <- standardize(fox_data$groupsize)
